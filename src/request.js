...
var http = require('http')
  ...
  , util = require('util');
const routesCache = require('./cache');
...
module.exports = function (app, config) {
  ...
  methods.forEach(function (method) {
    obj[method] = function (path) {
      return new Test(server, method, path, config)
        .on('end', function () {
          if (keepOpen === false) {
            obj.close();
          }
...
// requestResponse.on('setRequest', (reqData) => {

//   // if (!requestResponse.RequestInfo[reqData.path]) {
//   //   const data = {}
//   //   data[reqData.method] = {
//   //     request: reqData,
//   //   };
//   //   requestResponse.RequestInfo[reqData.path] = { ...requestResponse.RequestInfo[reqData.path], ...data};
//   // }
//   const swapReqInfo = {...requestResponse.RequestInfo};

//   console.log('SWAP DATA')
//   console.log(swapReqInfo)
//   console.log('SWAP DATA')

//   // else {
//   //   if (!requestResponse.RequestInfo[reqData.path][req.method]) {
//   //     requestResponse.RequestInfo[reqData.path][req.method] = {
//   //       ...requestResponse.RequestInfo[reqData.path][req.method],
//   //       request: reqData
//   //     }
//   //   }
...
//   // }
//   // if(!requestResponse.RequestInfo[reqData.path]){
//   //   requestResponse.RequestInfo[reqData.path] = {
//   //     request: reqData
//   //   }
//   // }
//   // else {
...
//   //   }
//   // }
//   // this.RequestInfo = reqData;
//   // console.log('SET REQUEST')
//   // console.log();
//   // console.log('SET REQUEST')

// })
// requestResponse.on('error', (e) => {
//   throw e;
// })
// requestResponse.on('setResponse', (resData) => {
//   console.log('SET RESPONSE')
//   console.log(requestResponse.RequestInfo[resData.path]);
//   console.log('SET RESPONSE')

//   if (!requestResponse.RequestInfo[resData.path]) {
//     const data = {}
//     data[resData.method] = {
//       response: resData
//     };
//     requestResponse.RequestInfo[resData.path] = {...requestResponse.RequestInfo[resData.path], ...data};
//   }
//   // else {
//   //   if (!requestResponse.RequestInfo[resData.path][resData.method]) {
//   //     requestResponse.RequestInfo[resData.path][resData.method] = {
//   //       ...requestResponse.RequestInfo[resData.path][resData.method],
//   //       response: resData
//   //     }
//   //   }
...
// requestResponse.on('generateDocs', () => {
//   console.log('FOR DOCS')
//   // console.log(requestResponse.RequestInfo);

//   Object.keys(requestResponse.RequestInfo).forEach(e => {
//     console.log(requestResponse.RequestInfo[e])
//   })
//   console.log('FOR DOCS')
// })
...
function Test(app, method, path, config) {
  routesCache.incrementTests();
